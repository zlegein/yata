...
describe('Directive: TideResults', function () {

  // load the directive's module
  beforeEach(module('tideResults', 'my.templates'));
...
//  });
  ...
  it('should not display the table if no tide-data are set', inject(function ($compile) {
    ...
    element = angular.element('<tide-results tide-data=""></tide-results>');
  ...
  describe('when there are search results', function () {
    ...
    beforeEach(inject(function($compile) {
      ...
      element = angular.element('<tide-results tide-data="results"></tide-results>');
      element = $compile(element)(scope);
